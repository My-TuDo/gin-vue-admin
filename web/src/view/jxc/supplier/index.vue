  ...
  <div class="jxc-page">
    <div class="gva-table-box">
      ...
      <div class="gva-search">
        <el-input v-model="keyword" placeholder="搜索编码/名称/联系人" clearable @clear="fetchData" @keyup.enter="fetchData" style="width: 280px" />
      ...
      <el-pagination
        ...
        layout="total, sizes, prev, pager, next" class="page-bar"
        @size-change="fetchData" @current-change="fetchData"
      />
    </div>

    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑供应商' : '新增供应商'" width="540px" class="crud-dialog" @closed="resetForm">
...
import { getSupplierList, createSupplier, updateSupplier, deleteSupplier, deleteSupplierForever, setSupplierStatus } from '@/api/jxc/basic'
...
async function fetchData() {
  loading.value = true
  try {
    const { data } = await getSupplierList({ page: page.value, pageSize: pageSize.value, keyword: keyword.value })
...
.gva-search .el-input { width: 280px !important; }
...
.cell-code { color: #909399; font-variant-numeric: tabular-nums; }
