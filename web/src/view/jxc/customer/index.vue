<template>
  <div class="jxc-page">
      ...
      <el-table :data="tableData" border v-loading="loading" class="pos-table">
        ...
        <el-table-column label="等级" width="90" align="center">
          <template #default="{ row }">
            <el-tag :type="levelTagType(row.level)" effect="light">{{ levelText(row.level) }}</el-tag>
          </template>
        </el-table-column>
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑客户' : '新增客户'" width="540px" class="crud-dialog" @closed="resetForm">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="84px">
        ...
        <div class="form-row">
          ...
          <el-form-item label="状态" prop="status">
            <el-switch v-model="form.status" :active-value="1" :inactive-value="0" active-text="正常" inactive-text="停用" style="height: 32px" />
          </el-form-item>
        </div>
