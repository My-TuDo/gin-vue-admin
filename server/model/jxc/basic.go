...
type GoodsCategory struct {
	...
	Code     string `json:"code" gorm:"column:code;type:size:50;not null;uniqueIndex:uk_code;comment:分类编码，全局唯一"`
...
type Brand struct {
	global.GVA_MODEL
	Code   string `json:"code" gorm:"column:code;type:size:50;not null;uniqueIndex:uk_code;comment:品牌编码，全局唯一"`
...
type Customer struct {
	...
	Name    string `json:"name" gorm:"column:name;size:100;not null;index:idx_name;comment:客户名称"`
